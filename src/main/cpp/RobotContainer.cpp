...
void RobotContainer::ConfigureButtonBindings()
{
  ...
  frc2::JoystickButton(&m_driverController, 5).ToggleOnTrue(IntakeCmd(m_intake, m_lights, m_driverController, m_auxController).ToPtr());
  ...
  if(chosenAuto == "Blue_Close4")
  {
    ...
    return frc2::cmd::Sequence( //the whole auto path!
      ...
      frc2::cmd::Parallel(
        ...
        IntakeCmd(m_intake, m_lights, m_driverController, m_auxController).ToPtr()
      ),
      frc2::cmd::Sequence(
