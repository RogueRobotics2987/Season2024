...
void RobotContainer::ConfigureButtonBindings()
{
  ...
  frc2::JoystickButton(&m_auxController, 3).ToggleOnTrue(ShooterLobCommand(m_shooter, m_intake, m_driverController, m_shooterWheels).ToPtr());
  ...
  if(chosenAuto == "Blue_Close4")
  {
    ...
    return frc2::cmd::Sequence( //the whole auto path!
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Blue_close4Waypoint2.emplace(Blue_close4Waypoint2.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      frc2::cmd::Parallel(
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Blue_close4Waypoint3.emplace(Blue_close4Waypoint3.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      frc2::cmd::Parallel(
  ...
  else if(chosenAuto == "Blue_FarSideMid")
  {
    ...
    return frc2::cmd::Sequence( //the whole auto path!
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Blue_FarSideMid2.emplace(Blue_FarSideMid2.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      frc2::cmd::Parallel(
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Blue_FarSideMid3.emplace(Blue_FarSideMid3.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Blue_FarSideMid4.emplace(Blue_FarSideMid4.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      frc2::cmd::Parallel(
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Blue_FarSideMid5.emplace(Blue_FarSideMid5.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
  ...
  else if(chosenAuto == "Red_FarSideMid")
  {
    ...
    return frc2::cmd::Sequence( //the whole auto path!
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Red_FarSideMid2.emplace(Red_FarSideMid2.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      frc2::cmd::Parallel(
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Red_FarSideMid3.emplace(Red_FarSideMid3.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      ...
      frc2::cmd::Sequence(
       ...
       frc2::cmd::RunOnce(
        [this]
          {
            Red_FarSideMid4.emplace(Red_FarSideMid4.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      frc2::cmd::Parallel(
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Red_FarSideMid5.emplace(Red_FarSideMid5.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
  ...
  else if(chosenAuto == "Blue_AmpSide")
  {
    ...
    return frc2::cmd::Sequence(
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Blue_AmpSide2.emplace(Blue_AmpSide2.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      frc2::cmd::Parallel(
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Blue_AmpSide3.emplace(Blue_AmpSide3.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      frc2::cmd::Parallel(
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Blue_AmpSide4.emplace(Blue_AmpSide4.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
  ...
  else if(chosenAuto == "Red_AmpSide")
  {
    ...
    return frc2::cmd::Sequence(
      ...
      frc2::cmd::RunOnce(
        [this]
          {
           Red_AmpSide2.emplace(Red_AmpSide2.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      frc2::cmd::Parallel(
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Red_AmpSide3.emplace(Red_AmpSide3.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
      frc2::cmd::Parallel(
      ...
      frc2::cmd::RunOnce(
        [this]
          {
            Blue_AmpSide4.emplace(Red_AmpSide4.begin(), m_drive.GetPose());
          },
          {&m_drive}
      ),
